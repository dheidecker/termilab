...
const { fakeServer: crearServidorFalso, COLECCIONES_SERVIDOR } = require('./lib/fake-sync-server');
const fakeServer = () => crearServidorFalso({ onBody: raw => cableTotal.push(raw) });
